...
export default function ResetPassword() {
    const { updatePassword, isAuthLoading, authError, clearAuthError } = useStore();
        ...
        return (
            <div className="auth">
                ...
                <p className="auth__footer">
                    <Link to="/login" className="auth__link">Go to login now</Link>
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="auth">
            ...
            <p className="auth__subtitle">Create a strong password for your account</p>
