...
import { Plus, Edit, Trash2, Search, Filter, Package, AlertTriangle, TrendingDown } from 'lucide-react';
...
export default function AdminProducts() {
    ...
    const filteredProducts = products.filter(product => {
        ...
        if (stockFilter === 'in_stock') {
            ...
            matchesStock = product.stock === undefined || product.stock > (product.low_stock_threshold || 10);
        } else if (stockFilter === 'low_stock') {
            matchesStock = product.stock !== undefined && product.stock > 0 && product.stock <= (product.low_stock_threshold || 10);
    ...
    const stockStats = {
        ...
        inStock: products.filter(p => p.stock === undefined || p.stock > (p.low_stock_threshold || 10)).length,
        lowStock: trackedProducts.filter(p => p.stock > 0 && p.stock <= (p.low_stock_threshold || 10)).length,
    ...
    if (error) {
        return (
            <div className="admin-page">
                <div className="admin-container">
                    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                        <p style={{ color: '#dc2626', marginBottom: '20px' }}>Error loading products: {error.message}</p>
            ...
            <div className="admin-container">
                ...
                <div className="stats-grid" style={{ marginBottom: '2rem' }}>
                    <div className="stat-card">
                        <div className="stat-icon" style={{ backgroundColor: '#16a34a15', color: '#16a34a' }}>
                            <Package size={24} />
                        </div>
                    ...
                    <div className="stat-card">
                        <div className="stat-icon" style={{ backgroundColor: '#dc262615', color: '#dc2626' }}>
