                                ...
                                <div key={order.id} className="order-card">
                                    <div className="order-card__header">
                                        ...
                                        <div className="order-card__total">
                                            ...
                                            <div style={{ fontSize: '1.5rem', fontWeight: 'var(--font-bold)' }}>
                                        ...
                                        {order.order_items?.slice(0, 3).map((item, idx) => (
                                            <div key={idx} className="order-item-preview">
                                                ...
                                                <div className="order-item-preview__details">
                                                    ...
                                                    <p>Size: {item.size} | Color: {item.color?.name || item.color}</p>
                                    ...
                                    <div className="order-card__footer">
                                        <div className="order-card__address">
                                            ...
                                            <span>{order.address?.name}, {order.address?.city}, {order.address?.state} - {order.address?.pincode}</span>
                                        </div>
                                        <Link to={`/order/${order.id}`} className="btn btn--secondary">
                                            View Details
                                        </Link>
                                    </div>
                                </div>
