...
import { reviews as allReviews, sizeGuide } from '../lib/productData';
    ...
    <div className="stars">
      {[1, 2, 3, 4, 5].map((i) => (
        <Star
          ...
          className={
            i <= Math.floor(rating)
              ? 'stars__star stars__star--filled'
              : 'stars__star'
          }
...
export default function ProductDetail() {
  ...
  // Initialize selectedColor when product loads (only once)
          ...
          <div className="pdp__info">
            ...
            <div className="pdp__price-row">
              ...
              {product.originalPrice > product.price && (
                <>
                  ...
                  <span className="pdp__price--discount">
            ...
            <div className="pdp__actions">
              ...
              <button
                ...
                style={{
                  color: isWishlisted ? 'var(--color-error)' : 'inherit',
                  borderColor: isWishlisted ? 'var(--color-error)' : '',
                }}
              >
                <Heart
                  size={20}
