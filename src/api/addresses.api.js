...
export async function checkPincodeServiceability(pincode) {
    try {
        const { data, error } = await supabase
            .rpc('check_pincode_serviceability', { p_pincode: pincode });
...
export async function addAddress(addressData) {
    try {
        ...
        if (!serviceabilityCheck.success || !serviceabilityCheck.data.is_serviceable) {
            return {
                success: false,
                error: 'This pincode is not serviceable. Please try a different address.'
            };
        }
